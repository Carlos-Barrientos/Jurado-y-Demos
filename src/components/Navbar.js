    ...
    <header class="sticky top-0 z-50 glass-header border-b border-surface-container-high transition-all">
      <div class="max-w-[1440px] mx-auto px-4 md:px-12 h-16 flex items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-4">
          <!-- Sync Indicator -->
          <div class="flex items-center gap-1.5 px-3 py-1 bg-green-500/10 text-green-600 rounded-full border border-green-500/20" title="Sincronizado en tiempo real">
            <div class="w-2 h-2 rounded-full bg-green-500 animate-pulse shadow-[0_0_8px_rgba(34,197,94,0.6)]"></div>
            <span class="text-[10px] font-bold uppercase tracking-widest hidden sm:inline">Live Sync</span>
          </div>
